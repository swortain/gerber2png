...
hints = [
    Hint(layer='top',
         ext=['gtl', 'cmp', 'top', ],
         name=['art01', 'top', 'GTL', 'layer1', 'soldcom', 'comp', 'F.Cu', 'copper_top'],
         regex='',
         content=[]
         ),
    Hint(layer='bottom',
         ext=['gbl', 'sld', 'bot', 'sol', 'bottom', ],
         name=['art02', 'bottom', 'bot', 'GBL', 'layer2', 'soldsold', 'B.Cu', 'copper_bottom'],
         regex='',
         content=[]
         ),
    Hint(layer='internal',
    ...
    Hint(layer='bottomsilk',
         ...
         name=['bsilk', 'ssb', 'botsilk', 'B.SilkS','silkscreen_bottom'],
         regex='',
         content=[]
         ),
    Hint(layer='topmask',
    ...
    Hint(layer='bottommask',
         ...
         name=['sm', 'bmask', 'mask2', 'masksold', 'botmask', 'msb', 'B.Mask','soldermask_bottom'],
         regex='',
         content=[]
         ),
    Hint(layer='toppaste',
    ...
    Hint(layer='bottompaste',
         ...
         name=['sp02', 'botpaste', 'psb', 'B.Paste', 'solderpaste_bottom'],
         regex='',
         content=[]
         ),
    Hint(layer='outline',
